...
enum class BeerType{LIGHT_LAGER, LIGHT_HYBIRD, BOCK, AMBER_HYBRID, FRUIT}
...
fun Wine.euro_to_won(operation:(Int, Int) -> Int){println("유료 : ${cost} , 원화 : ${operation(cost, 1350)}")}

fun main() {
    var beer1 = Beer("Hite", BeerType.FRUIT, 200)
    var beer2 = Beer("Cass", BeerType.LIGHT_HYBIRD, 200)
